        ...
        while (restart) {
            while (work) {
                ...
                if (ok){
                    ...
                    System.out.println("\nПеревірка зайняла:");
                    System.out.println((double) (System.currentTimeMillis() - mmm));}
                else {
                ...
                if (ok) {
                    ...
                    System.out.println("\nПеревірка зайняла:");
                    System.out.println((double) (System.currentTimeMillis() - jk));}
                else{
            ...
            System.out.println("\nПеревірка зайняла:");
            System.out.println((double) (System.currentTimeMillis() - iu));
            ...
            if (Fp > fisherNow) {
                ...
                System.out.println("\nПеревірка зайняла:");
                System.out.println((double) (System.currentTimeMillis() - yu));
                ...
                System.out.println("\nПеревірка зайняла:");
                System.out.println((double) (System.currentTimeMillis() - rt));
                ...
                System.out.println("\nПеревірка зайняла:");
                System.out.println((double) (System.currentTimeMillis() - tr));
